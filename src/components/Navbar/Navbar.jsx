...
import brandIcon from "../../assets/brand/company-icon.png";
        ...
        <nav className="w-full lg:mx-auto">
          ...
          >
            <li className="">
              <a
                href="#"
                className="relative text-[#3341a9] after:absolute after:left-0 after:-bottom-2 after:block after:h-[2px] after:w-0 after:bg-[#3341a9] after:duration-300 hover:after:w-full"
              >
                Home
              </a>
            </li>
