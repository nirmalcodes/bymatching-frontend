...
import { Divider, SectionWrapper } from "../../components";
        ...
        <div className="mt-7 flex flex-row flex-wrap gap-x-10 gap-y-4 xl:mt-20">
          <div className="flex w-full overflow-hidden  xl:flex-1 xl:rounded-tr-full xl:rounded-br-full">
            <img
              ...
              alt=""
              className="h-auto min-h-[260px] max-h-[600px] w-full object-cover xl:aspect-video"
            />
          </div>
...
export default SectionWrapper(AboutUs1, "about");
